...
Ships, Population Cubes, Influence Discs, Tech Tiles, Discovery Tiles, Reputation Tiles, Sectors, and Ambassador Tiles are all limited to the components included in the game. If they run out, they run out. All other game components are meant to be unlimited.

### Warp Portals (Optional Module)

The Warp Portals are an optional module. The Warp Portals consist of three Sectors [one Middle (II) and two Outer (III)], one Discovery Tile, one Rare Tech, and one Warp Portal Tile. To use the module, shuffle components with base game components. All Sectors with Warp Portals are considered to be adjacent to each other and have a full Wormhole Connection between them.
...
1. **Return** any number of Ship Part Tiles from your Blueprints to the Upgrade Tray.
...
- **Missiles:** Fire once before engagement rounds.
- **Engagement Rounds:** Repeat until one side Retreats or is destroyed.
- Activate Ships in Initiative order.
- Roll dice for Weapons.
- **Hit:** 6+ (after Computer + and Shield - modifiers). A "Burst" symbol (6 on die) is always a hit. 1 is always a miss.
- **Damage:** Assign damage to Ships. If damage >= Hull, Ship is destroyed.
...
**Retreating:** Ships may Retreat to a Controlled Sector with no enemies via a Wormhole. They move at the start of the _next_ engagement round but can be shot at before they leave.
...
1. **Techs:** Draw new Tech Tiles based on player count.
2. **Reset:** Return Influence Discs from Action Spaces to Track. Flip Colony Ships/Summary Tile faceup.
...
- **Start:** 4 Materials, 2 Science, 26 Money. 3 Colony Ships.
- **Sector:** 222
...
- **Sector:** 224
- **Tech:** Advanced Labs.
- **Special:** Research very fast (2 Research Actions per activation, usually). Start with a Science Cube in Advanced Science square.
...
- **Sector:** 226
- **Tech:** Starbase.
- **Special:** Explore twice per action. Population destroyed by enemy Ships at end of Combat. +1 VP per Controlled Sector. Ships have weak Initiative but extra Power/Computer.
...
- **Sector:** 228
- **Tech:** Fusion Drive.
- **Special:** Explore: Flip 2 sectors, keep 1. Peaceful with Ancients (can share sectors, don't fight). 1 VP per Ancient on board at game end.
...
- **Special:** 3 Upgrade/Build activations. Cheaper Building costs.
...
- **Special:** Start with Cruiser instead of Interceptor. Increased Initiative. Ships have extra Energy.
