...
- continuous async update. Just show one-line stats along the bottom that async calculate/update when *anything* is changed. it could be expanded for more detail like probability of ships being lost.
